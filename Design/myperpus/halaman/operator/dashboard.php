        ...
        <div id="page-wrapper" >
			...
			<div class="panel panel-back noti-box">
                <span class="icon-box bg-color-green set-icon">
                    <a href="data/transaksi/transaksi_buku.php" class="fa fa-bell-o" style="color:white;"></a>
                </span>
                <div class="text-box" >
			...
			<div class="panel panel-back noti-box">
                <span class="icon-box bg-color-blue set-icon">
                    <a href="data/anggota/data_anggota.php" style="color:white;" class="fa fa-bars"></a>
                </span>
                <div class="text-box" >
			...
			<div class="panel panel-back noti-box">
                <span class="icon-box bg-color-brown set-icon">
                    <a href="akun/tambah/tambah_anggota.php" style="color:white;" class="fa fa-rocket"></a>
                </span>
                <div class="text-box" >
                    <a href="akun/tambah/tambah_anggota.php" style="color:black;" class="main-text">Tambah</a>
                    <p class="text-muted">Akun Anggota</p>
                </div>
             </div>
		     </div>
			</div>
