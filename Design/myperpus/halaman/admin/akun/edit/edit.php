           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../tambah/tambah_akun.php">Tambah Akun</a>
                            </li>
                            <li>
                                <a class="active-menu" href="akun/edit/edit.php">Edit Akun</a>
                            </li>
                    </li>
            </div>
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <form role="form" action="proses_edit.php" method="POST">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="level" value="Admin" readonly />
                    </div>  
                    <div>
