                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        include "../../../../koneksi.php";
                                        $no = 1;
                                        $ambil = mysqli_query($koneksi,"SELECT*FROM tab_transaksi WHERE status='Pinjam'");
                                        while ($data = mysqli_fetch_array($ambil)) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <a href="kembali.php?id=<?php echo $data['id_transaksi']; ?>"class="btn btn-primary">Kembalikan</a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        include "../../../../koneksi.php";
                                        $no = 1;
                                        $ambil = mysqli_query($koneksi,"SELECT*FROM tab_transaksi WHERE status='Kembali'");
                                        while ($data = mysqli_fetch_array($ambil)) {
                                            ?>
                                            <tr class="odd gradeX">
                                                <td><?php echo $no++; ?></td>
