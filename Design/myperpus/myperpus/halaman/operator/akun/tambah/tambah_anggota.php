...
<head>
    ...
    <title>Tambah Anggota | Operator</title>
	<!-- BOOTSTRAP STYLES-->
...
font-size: 16px;"><a href="../../../logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu" href="tambah_anggota.php">Tambah Akun Anggota</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Form Tambah Akun Anggota</h2>  
                    </div>
                </div>              
                 <!-- /. ROW  -->
                ...
                <form role="form" action="input_anggota.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="ulang_pass" required />
                                        </div>
                                        <div class="form-group">
                                            <label>Level</label>
                                            <input class="form-control" name="level" value="Anggota" readonly />
                                        </div> 
                                        <div>
