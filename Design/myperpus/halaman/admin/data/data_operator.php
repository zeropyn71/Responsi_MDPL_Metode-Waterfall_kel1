...
<head>
    ...
    <title>Data Operator | Admin</title>
	<!-- BOOTSTRAP STYLES-->
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu" href="data_operator.php">Data Operator</a>
                            </li>
                            <li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        ...
                                        include "../../../koneksi.php";
                                        $no = 1;
                                        $ambil = mysqli_query($koneksi,"SELECT*FROM tab_user WHERE level='Operator'");
