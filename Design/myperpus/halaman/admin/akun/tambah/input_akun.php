...
if ($password == $ulang_pass) {
      ...
      if ($sql) {
            echo "<script>
                        alert('Berhasil menambahkan data!');document.location='tambah_akun.php'
                  </script>";
      }else {
            echo "<script>
                  alert('Gagal menambahkan data!');document.location='tambah_akun.php'
            </script>";
      }
}else {
      echo "<script>
                  alert('Gagal menambahkan data!, password dan ulangi password tidak sesuai!');document.location='tambah_akun.php'
            </script>";
}
