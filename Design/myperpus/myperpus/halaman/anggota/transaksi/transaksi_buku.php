           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu" href="transaksi_buku.php"><i class="fa fa-table fa-3x"></i> Transaksi</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <a href="pinjam.php" class="btn btn-primary">+ Pinjam Buku</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        $ambil = mysqli_query($koneksi,"SELECT*FROM tab_transaksi WHERE status='Pinjam' and no_induk = '$no_induk'");
                    ...
                    <div class="panel panel-default">
                <div class="panel-heading">
                    <h5>Histori transaksi peminjaman </h5>
                </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $no_induk = $_SESSION['no_induk'];
                                        $no = 1;
                                        $ambil = mysqli_query($koneksi,"SELECT*FROM tab_transaksi WHERE status='Kembali' and no_induk = '$no_induk'");
                                        while ($data = mysqli_fetch_array($ambil)) {
                                            ?>
                                            <tr class="odd gradeX">
                                                <td><?php echo $no++; ?></td>
